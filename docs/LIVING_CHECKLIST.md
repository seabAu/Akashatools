...
- [x] Add dependency-free runtime tests; 85 tests currently pass.
...
- [x] Give every public function a complete JSDoc summary, generic types,
  ...
  All 117 public declarations are complete, with parameter/return prose,
...
- [x] Add `@since 2.0.0` and `@deprecated` consistently, enforced across all
  117 public declarations by `npm run check:docs`.
